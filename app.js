...
//Removed md5 as chosen hashing tool
//const md5 = require('md5'); //For hashing

//Removed encryption in favour of hashing passwords
...
//Removed this register/login code which used bcrypt. Commented for future reference.
/*
app.post("/register", function(req, res) {
  ...
  bcrypt.hash(req.body.password, saltRounds, function(err, hash) {
    const newUser = new User({
      ...
      password: hash
      //password: md5(req.body.password) //For hashing
    });
    ...
    if (err) {
      ...
      if (foundUser) {
        bcrypt.compare(password, foundUser.password, function(err, result) {
          if (result === true) {
            //if password after hashing with the salt is equal to the hash in database
            res.render("secrets");
          }
        });
